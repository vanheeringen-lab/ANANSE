...
`--columns SAMPLE1 sample3` will use samples 1 and 3, but ignores sample 2.
...
`--columns TpM` will use the `tpm` column. This may be useful if your files have a different column name (e.g. `counts`)
